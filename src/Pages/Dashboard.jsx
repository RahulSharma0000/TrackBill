...
const Dashboard = () => {
  ...
  return (
    <div className="p-4 md:p-8 max-w-screen-xl mx-auto">
      <h1 className="text-2xl font-bold text-gray-800 mb-6 text-center md:text-left">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
        <div className="bg-white rounded-2xl shadow-md p-6 text-center sm:text-left">
          ...
          <p className="text-2xl font-bold text-indigo-600 mt-1">₹10,000</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6 text-center sm:text-left">
          <h2 className="text-sm font-semibold text-gray-500">This Week</h2>
          <p className="text-2xl font-bold text-emerald-600 mt-1">₹2,000</p>
        </div>
        <div className="bg-white rounded-2xl shadow-md p-6 text-center sm:text-left">
          <h2 className="text-sm font-semibold text-gray-500">This Month</h2>
          <p className="text-2xl font-bold text-yellow-600 mt-1">₹6,500</p>
        </div>
      </div>
